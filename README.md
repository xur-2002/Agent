...
## Universal Ad CLI PowerShell Quick Verify

### 1) Set OpenAI-compatible Groq + Serper environment

```powershell
$env:LLM_BASE_URL="https://api.groq.com/openai/v1"
$env:LLM_API_KEY="你的_gsk_..."
$env:LLM_MODEL="groq/compound"
$env:SERPER_API_KEY="你的_serper_..."
```

### 2) One-command generation (3 channels)
